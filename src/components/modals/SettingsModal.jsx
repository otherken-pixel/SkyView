    ...
    <div className="ios-sheet-overlay" onClick={e => { if (e.target === e.currentTarget) onClose(); }}
      ...
      <div className="ios-sheet">
        ...
        <div style={{ padding: '16px 24px 20px', display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div>
            <div style={{ fontSize: 12, fontWeight: 600, letterSpacing: '0.3px', color: 'var(--accent)', borderBottom: '1px solid var(--card-border-soft)', paddingBottom: 8, marginBottom: 10 }}>Airport Database (OurAirports)</div>
